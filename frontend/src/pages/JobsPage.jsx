...
export default function JobsPage() {
 ...
 <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center text-xl font-bold text-white shrink-0">{job.company_name?.[0] || 'C'}</div>
 ...
 <span className="text-xs bg-orange-50 text-orange-600 px-2 py-1 rounded-full"> {formatDate(job.created_at)}</span>
 </div>
 </div>
